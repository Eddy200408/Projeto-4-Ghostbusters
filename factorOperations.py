...
def joinFactors(factors: List[Factor]):
    ...
    # Garantir que factors seja uma lista (caso seja passado como dict_values)
    factors = list(factors)

    # Determinar as variáveis incondicionais e condicionais do novo fator
    unconditioned = set()
    conditioned = set()
    ...
    # Preencher as probabilidades no novo fator
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        # Calcular as probabilidades do novo fator somando sobre os valores eliminados
        for assignment in new_factor.getAllPossibleAssignmentDicts():
            prob = 0
